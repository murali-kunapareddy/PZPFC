...
namespace PFCRepository.Repositories.Configure
{
    public class ConfigureRepository : IConfigureRepository
    {
        ...
        private GenericRepository<MvkeOverride> _MvkeOverrideRepository;
        private GenericRepository<ETLJobProcessHistory> _ETLJobProcessHistoryRepository;
        ...
        public GenericRepository<MvkeOverride> MvkeOverrideRepository => _MvkeOverrideRepository ?? (_MvkeOverrideRepository = new GenericRepository<MvkeOverride>(_dbContext));

        public GenericRepository<ETLJobProcessHistory> ETLJobProcessHistoryRepository => _ETLJobProcessHistoryRepository ?? (_ETLJobProcessHistoryRepository = new GenericRepository<ETLJobProcessHistory>(_dbContext));
