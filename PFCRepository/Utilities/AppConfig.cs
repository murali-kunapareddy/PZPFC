...
namespace PFCRepository.Utilities
{
    public class AppConfig
    {
        ...
        public static string CurrentPriceFileDistribution
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["CurrentPriceFileDistribution"].ToString().Trim(); }
        }
        public static string PendingPriceFileDistribution
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["PendingPriceFileDistribution"].ToString().Trim();  }
        }
        public static string CurrentPendingPriceFileDistribution
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["CurrentPendingPriceFileDistribution"].ToString().Trim();  }
        }
        public static string DailyLimitExceeded
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["DailyLimitExceeded"].ToString().Trim(); }
        }
        public static string MonthlyLimitExceeded
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["MonthlyLimitExceeded"].ToString().Trim(); }
        }
        public static string MissingCustomerSettings
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["MissingCustomerSettings"].ToString().Trim(); }
        }
        public static string MissingCustomer
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["MissingCustomer"].ToString().Trim(); }
        }
        public static string MissingExcelData
        {
            get { return ApiNotificationTemplates.ApiNotificationTemplate["MissingExcelData"].ToString().Trim(); }
        }
    ...
    static class ApiNotificationTemplates
    {
        public static IConfiguration ApiNotificationTemplate { get; }
        static ApiNotificationTemplates()
        {
            var basePath = AppDomain.CurrentDomain.BaseDirectory;
            ApiNotificationTemplate = new ConfigurationBuilder()
                    .SetBasePath(basePath)
                    .AddJsonFile("appsettings.json")
                    .Build().GetSection("ApiNotificationTemplates");
